...
export class ContainersComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal, public ds: ContainerDataService,private usrds:UserDataService, public fb: FormBuilder) { }
  ...
  ngOnInit(): void {
    this.ds.getcontainerData().subscribe((data:any)=>this.totalcontainers=data.length);
    this.ds.getcontainerDetailsData(this.usrds.logintid).subscribe((data) => this.fatchContainerData(data));
  ...
  containerData() {
    // console.log(this.containerFormData.value);
    ...
    this.postContainerData = {
      "id": ++(this.totalcontainers),
      "con_id": this.containerFormData.value.container_id,
      "contype_id": this.containerFormData.value.container_type,
      "terminal_id_origin": this.usrds.logintid,
      "terminal_id_current": this.usrds.logintid,
      "status": this.containerFormData.value.status
    }
    // console.log(this.postContainerData);
    this.ds.postContainerDetailsData(this.postContainerData).subscribe((data:any) => this.container_Data.push(data));
  }
